...
tab, its environment panel and its production-knowledge folder working; the
model passes behind it are next. See
...
* `production/`: A show's own markdown — characters and terminology. Contents gitignored.
